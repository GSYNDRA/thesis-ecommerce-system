...
import _key_token from  "./key_token.js";
...
import _refresh_token_used from  "./refresh_token_used.js";
...
export default function initModels(sequelize) {
  ...
  const key_token = _key_token.init(sequelize, DataTypes);
  ...
  const refresh_token_used = _refresh_token_used.init(sequelize, DataTypes);
  ...
  refresh_token_used.belongsTo(key_token, { as: "key_token", foreignKey: "key_token_id"});
  key_token.hasMany(refresh_token_used, { as: "refresh_token_useds", foreignKey: "key_token_id"});
  ...
  key_token.belongsTo(user, { as: "user", foreignKey: "user_id"});
  user.hasMany(key_token, { as: "key_tokens", foreignKey: "user_id"});
